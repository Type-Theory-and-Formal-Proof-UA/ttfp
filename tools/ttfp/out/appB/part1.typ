...
// The appendix is lettered "B", not numbered like a chapter; its statements
// carry the numbers they have in chapter 14 (label: on each one).  "B.1"
// gives the heading the letter while leaving the appendix section-free, and
// the counter reset after it is what assemble.py carries into the merged file
// (it drops the lines before the level-1 heading); without it the appendix
// inherits the previous chapter's number.
#set heading(numbering: "B.1")
