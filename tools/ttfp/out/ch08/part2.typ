...
#exercise[
  ...
  #align(center)[
    ...
    [Які константи введено в цьому тексті, а які було введено раніше?],
...
#exercise[
  ...
  #align(center)[
    ...
    [Перепишіть рядки (1) і (2) у форматі $Gamma triangle.r a(dots.h.c) := M : N$, як
...
#exercise[
  ...
  #block(inset: (left: 1.5em))[
    «Дійсне число $r$ є раціональним, якщо існують цілі числа $p$ і $q$, де
...
#exercise[
  ...
  #block(inset: (left: 1.5em))[
    ...
    конгруентне з $l$ за модулем $m$, якщо $m$ ділить $k - l$. Ми пишемо
    $k equiv l ("mod" m)$, щоб указати, що $k$ конгруентне з $l$ за модулем $m$.
