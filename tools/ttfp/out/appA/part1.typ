...
// ⊥⊥ — у друкованому оригіналі (рядок (22) та місця, де позначник примітивного
// означення трапляється в тексті) набрано двома символами ⊥; відтворюємо як в оригіналі.
#let dblbot = $bot #h(-0.12em) bot$

// Один пронумерований рядок довідника: номер ліворуч; засновки (кожен у рамці) над
...
// Рядки вертикальних крапок, що позначають пропущений фрагмент виведення.
